...
- **No more flashing console windows**: PowerShell (AppX removal), DISM
  component cleanup, and scheduled-task queries now spawn with
  `CREATE_NO_WINDOW`, so background operations no longer flash a console
  window over the GUI.
